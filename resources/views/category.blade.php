...
<body>
    <section class="categories">
        <h2>Categories</h2>
        <div class="category">
            <img src="{{ asset('images/menshoes.png') }}" alt="">
            <p>Men</p>
        ...
        <div class="category">
            <img src="{{ asset('images/kidshoes.png') }}" alt="">
            <p>Kids</p>
    ...
    <section class="products">
        <h2>Trending Now</h2>
        <div class="product">
            <img src="{{ asset('images/nikeairmax270.png') }}" alt="">
        ...
        <div class="product">
            <img src="{{ asset('images/nikemenair.png') }}" alt="">
            <div class="product-info">
                <h3>Nike Air Max 270</h3>
                <p>$145</p>
                <a href="#"><i class="fa-solid fa-cart-shopping"></i></a>
        ...
        <div class="product">
            <img src="{{ asset('images/nikeairforce1.png') }}" alt="">
            <div class="product-info">
                <h3>Nike Air Max 270</h3>
                <p>$145</p>
                <a href="#"><i class="fa-solid fa-cart-shopping"></i></a>
