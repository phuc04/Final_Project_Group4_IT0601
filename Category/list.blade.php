                            ...
                            <div class="panel-heading">
                                <div class="panel-options">
                                    <ul class="nav nav-tabs">
                                        <li><a class="nav-link active" href="#tab-1" data-toggle="tab">List Cate</a>
                                        </li>
                                        <li><a class="nav-link" href="#tab-2" data-toggle="tab">List SubCate</a></li>
                                        <li><a class="nav-link" href="#tab-3" data-toggle="tab">List Sorting</a></li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab-3">
                                        ...
                                        <div class="ibox ">
                                            <div class="tabhover">
                                                <p class="m-b-lg">
                                                    <strong>Is</strong> an interactive hierarchical list. You can drag and drop to
