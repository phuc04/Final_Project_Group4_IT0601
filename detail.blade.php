                                    ...
                                    <div class="product-shop col-lg-8 col-sm-7 col-xs-12">
                                        ...
                                        <div class="price-block">
                                            <div class="price-box">
                                                ...
                                                @else
                                                    <p class="availability out-of-stock pull-right"><span>Out Stock</span>
                                                    </p>
                                                @endif
                                            </div>
                                        </div>
                                            ...
                                            <ul class="add-to-links">
                                                <li>
                                                    ...
                                                    @endphp
                                                        ...
                                                        id="{{ $product_detail->product_id }}"><span>Add to Wishlist</span></a>
                                                        @else
                            ...
                            <div class="product-collateral">
                                <div class="add_info">
                                    <ul id="product-detail-tab" class="nav nav-tabs product-tabs">
                                        ...
                                        <li><a href="#reviews_tabs" data-toggle="tab">Reviews ({{ count($review) }})</a></li>
                                    </ul>
                                    <div id="productTabContent" class="tab-content">
                                        ...
                                        <div class="tab-pane fade" id="product_tabs_tags">
                                            <div class="box-collateral box-tags">
                                                ...
                                                <!--tags-->
                                                <p class="note">Uses paces to separate tags. Uses ingle quotes ()
                                                    for
                                                    phrases.</p>
                                            </div>
                                        </div>
