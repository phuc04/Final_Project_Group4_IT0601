                     ...
                     <ul class="stat-list">
                        <li>
                           ...
                           <div class="stat-percent">
                               {{ $ttr_sales > 0 ? round(($tn_sales-$ttr_sales)/$ttr_sales*100,0)/100 : 0 }}%
                            @if ($ttr_sales > 0)
                        ...
                        <li>
                           ...
                           <small>Orders</small>
                           <div class="stat-percent">
                               {{ $tn_total > 0 ? round(($tn_total-$ttr_total)/$ttr_total*100,0)/100 : 0}}%
                            @if ($tn_total > 0)
                        ...
                        <li>
                           ...
                           <div class="stat-percent">{{ $tn_profit > 0 ? round(($tn_profit-$ttr_profit)/$ttr_profit*100,0)/100 : 0 }}%
                            @if ($tn_profit > 0)
                                @if (round(($tn_sales-$ttr_sales)/$ttr_sales*100,0)/100 <= 0)
                                <i class="fa fa-level-down text-navy text-danger"></i>
                                @else
