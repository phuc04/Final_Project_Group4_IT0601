                                ...
                                <tbody>
                                    <tr class="product-shop-row first odd">
                                        ...
                                        <td>
                                            ...
                                            <p>
                                                <button type="button" title="Add to Cart" class="button add_cart" data-id_pro="{{ $compe->product_id }}"><span><span>Add to Cart</span></span></button>
                                            </p>
                                            @if (Auth::user())
                                            @php
                                            ...
                                            @endphp
                                                ...
                                                id="{{ $compe->product_id }}">Add to Wishlist</a>
                                                @else
                                            ...
                                            <a class="button wishlist"
                                                href="{{ route('login.index') }}">Add to Wishlist</a>
                                            @endif
                                        </td>
                                        @endforeach
                                        @endforeach
