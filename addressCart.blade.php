                                            ...
                                            <div class="table-responsive">
                                                <fieldset class="multiple-checkout shipping">
                                                    <div class="form-group form-list">
                                                        <label class="required" for="name">Full Name <em>*</em></label>
                                                        <input name="checkout_name" id="checkout_name" value="{{ Auth::user()->name }}" type="text" style="width: 100%;margin-bottom: 2%;" class="input-text required-entry" required placeholder="Name">
                                                    </div>
                                                    <div class="form-group form-list">
                                                        <label class="required" for="phone">Phone <em>*</em></label>
                                                        <input name="checkout_phone" id="checkout_phone" type="tel" style="width: 100%;margin-bottom: 2%;" pattern="[0-9]{10}" required class="input-text required-entry" placeholder="Phone">
                                                    </div>
                                                    <div class="form-group form-list">
                                                        <label class="required" for="address">Address <em>*</em></label>
                                                        <input name="checkout_address" id="checkout_address" type="text" style="width: 100%;margin-bottom: 2%;" class="input-text required-entry" required placeholder="apartment number
                                                        ">
                                                    </div>
                                                    <div class="form-group form-list">
                                                    ...
                                                    <div class="form-group form-list">
                                                        ...
                                                        <select style="width: 100%; margin-bottom: 2%;" required class="choose_card" name="checkout_payment" id="checkout_payment">
                                                            ...
                                                            <option value="ATM">Payment via card</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group form-list paycard display">
                                                        <label class="required" for="card">Card <em>*</em></label>
                                                    ...
                                                    <div class="form-group form-list">
                                                        ...
                                                        <textarea name="checkout_note" id="checkout_note" rows="5" style="width: 100%;margin-bottom: 2%;" class="input-text required-entry" placeholder="Note"></textarea>
                                                    </div>
                                                    <div class="buttons-set">
                                                        <a href="{{ url()->previous() }}" class="back-link"><small>« </small>Back to Shopping Cart</a>
                                                        <button class="button btn-continue" title="Continue to Shipping Information"
                                                            type="submit"><span>Continue to Shipping Information</span>
                                                        </button>
