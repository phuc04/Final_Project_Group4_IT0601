...
class ProductController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $gallery = Gallery::where('pro_id', $id)->get();
        ...
        foreach ($gallery as $value) {
            if ($value->gallery_image != 'default.jpg') {
                if (File::exists(public_path('uploads/gallery/') . $value->gallery_image)) {
                    File::delete(public_path('uploads/gallery/') . $value->gallery_image);
                }
            }
        }
